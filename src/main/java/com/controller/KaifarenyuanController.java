...
public class KaifarenyuanController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(kaifarenyuan,deSens);
    ...
    public R save(@RequestBody KaifarenyuanEntity kaifarenyuan, HttpServletRequest request){
        ...
        kaifarenyuanService.insert(kaifarenyuan);
        return R.ok().put("data",kaifarenyuan.getId());
    }
    ...
    public R update(@RequestBody KaifarenyuanEntity kaifarenyuan, HttpServletRequest request){
        ...
        //全部更新
        kaifarenyuanService.updateById(kaifarenyuan);
        if(null!=kaifarenyuan.getKaifazhanghao())
        {
            // 修改token
            TokenEntity tokenEntity = new TokenEntity();
            tokenEntity.setUsername(kaifarenyuan.getKaifazhanghao());
            tokenService.update(tokenEntity, new EntityWrapper<TokenEntity>().eq("userid", kaifarenyuan.getId()));
        }
        return R.ok();
    }
