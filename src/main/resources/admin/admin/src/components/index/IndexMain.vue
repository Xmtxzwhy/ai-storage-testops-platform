<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 220px","margin":"0","background":"#E7E7E7","display":"block","overflow-x":"hidden","position":"relative"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"border":"1px solid #D8D8D8","padding":"0 20px 0 20px","alignItems":"center","color":"#FFFFFF","display":"flex","justifyContent":"space-between","top":"0","left":"40px","background":"#FFC144","width":"100%","fontSize":"16px","position":"inherit","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"border":"1px solid #D8D8D8","width":"calc(100% - 40px)","padding":"20px 40px","margin":"0px auto 0 40px","fontSize":"16px","background":"#fff"}' class="bread-crumbs"></bread-crumbs>
