	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="测试用例" prop="ceshiyongli" >
					<el-input v-model="ruleForm.ceshiyongli" placeholder="测试用例" clearable  :readonly="ro.ceshiyongli"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="测试用例" prop="ceshiyongli" >
					<el-input v-model="ruleForm.ceshiyongli" placeholder="测试用例" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="工程师号" prop="gongchengshihao" >
					<el-input v-model="ruleForm.gongchengshihao" placeholder="工程师号" clearable  :readonly="ro.gongchengshihao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="工程师号" prop="gongchengshihao" >
				...
				<el-form-item class="select" v-if="type!='info'"  label="测试结果" prop="ceshijieguo" >
					<el-select :disabled="ro.ceshijieguo" v-model="ruleForm.ceshijieguo" placeholder="请选择测试结果" >
						<el-option
							v-for="(item,index) in ceshijieguoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="测试结果" prop="ceshijieguo" >
					<el-input v-model="ruleForm.ceshijieguo"
						placeholder="测试结果" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="分析师号" prop="fenxishihao" >
					<el-input v-model="ruleForm.fenxishihao" placeholder="分析师号" clearable  :readonly="ro.fenxishihao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="分析师号" prop="fenxishihao" >
					<el-input v-model="ruleForm.fenxishihao" placeholder="分析师号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="分析师名" prop="fenxishiming" >
					<el-input v-model="ruleForm.fenxishiming" placeholder="分析师名" clearable  :readonly="ro.fenxishiming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="分析师名" prop="fenxishiming" >
					<el-input v-model="ruleForm.fenxishiming" placeholder="分析师名" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item class="textarea" v-if="type!='info'" label="执行顺序" prop="zhixingshunxu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="执行顺序"
					v-model="ruleForm.zhixingshunxu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zhixingshunxu" label="执行顺序" prop="zhixingshunxu" >
				<span class="text">{{ruleForm.zhixingshunxu}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="执行条件" prop="zhixingtiaojian" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="执行条件"
					v-model="ruleForm.zhixingtiaojian" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.zhixingtiaojian" label="执行条件" prop="zhixingtiaojian" >
				<span class="text">{{ruleForm.zhixingtiaojian}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="缺陷修复" prop="quexianxiufu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="缺陷修复"
					v-model="ruleForm.quexianxiufu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.quexianxiufu" label="缺陷修复" prop="quexianxiufu" >
				<span class="text">{{ruleForm.quexianxiufu}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="代码改进" prop="daimagaijin" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="代码改进"
					v-model="ruleForm.daimagaijin" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.daimagaijin" label="代码改进" prop="daimagaijin" >
				<span class="text">{{ruleForm.daimagaijin}}</span>
			</el-form-item>
			<el-form-item class="textarea" v-if="type!='info'" label="改进建议" prop="gaijinjianyi" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="改进建议"
					v-model="ruleForm.gaijinjianyi" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.gaijinjianyi" label="改进建议" prop="gaijinjianyi" >
				<span class="text">{{ruleForm.gaijinjianyi}}</span>
			</el-form-item>
...
<script>
	export default {
		data() {
			return {
				...
				rules: {
					...
					zhixingtiaojian: [
						{ required: true, message: '执行条件不能为空', trigger: 'blur' },
					],
					jinglizhanghao: [
					],
					jinglixingming: [
					...
					gaijinjianyi: [
						{ required: true, message: '改进建议不能为空', trigger: 'blur' },
					],
					fenxishihao: [
					],
					fenxishiming: [
		...
		created() {
			this.ruleForm.fenxishijian = this.getCurDateTime()
		},
		methods: {
			// 下载
			download(file){
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='ceshiyongli'){
							this.ruleForm.ceshiyongli = obj[o];
							this.ro.ceshiyongli = true;
							continue;
						}
						if(o=='zhixingshunxu'){
							this.ruleForm.zhixingshunxu = obj[o];
							this.ro.zhixingshunxu = true;
							continue;
						}
						if(o=='zhixingtiaojian'){
							this.ruleForm.zhixingtiaojian = obj[o];
							this.ro.zhixingtiaojian = true;
							continue;
						}
						if(o=='jinglizhanghao'){
						...
						if(o=='quexianxiufu'){
							this.ruleForm.quexianxiufu = obj[o];
							this.ro.quexianxiufu = true;
							continue;
						}
						if(o=='daimagaijin'){
							this.ruleForm.daimagaijin = obj[o];
							this.ro.daimagaijin = true;
							continue;
						}
						if(o=='kaifazhanghao'){
						...
						if(o=='gaijinjianyi'){
							this.ruleForm.gaijinjianyi = obj[o];
							this.ro.gaijinjianyi = true;
							continue;
						}
						if(o=='fenxishihao'){
							this.ruleForm.fenxishihao = obj[o];
							this.ro.fenxishihao = true;
							continue;
						}
						if(o=='fenxishiming'){
							this.ruleForm.fenxishiming = obj[o];
							this.ro.fenxishiming = true;
							continue;
						}
					}
				}
				...
				this.$http({
					...
					if (data && data.code === 0) {
						var json = data.data;
						if(((json.fenxishihao!=''&&json.fenxishihao) || json.fenxishihao==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.fenxishihao = json.fenxishihao
							this.ro.fenxishihao = true;
						}
						if(((json.fenxishiming!=''&&json.fenxishiming) || json.fenxishiming==0) && this.$storage.get("role")!="管理员"){
							this.ruleForm.fenxishiming = json.fenxishiming
							this.ro.fenxishiming = true;
						}
					} else {
				...
				this.ceshijieguoOptions = "优,良,中,差".split(',')
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `ceshifenxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.ceshifenxiCrossAddOrUpdateFlag = false;
											this.parent.search();
