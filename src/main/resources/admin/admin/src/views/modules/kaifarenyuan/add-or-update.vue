	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="开发电话" prop="kaifadianhua" >
					<el-input v-model="ruleForm.kaifadianhua" placeholder="开发电话" clearable  :readonly="ro.kaifadianhua"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="开发电话" prop="kaifadianhua" >
					<el-input v-model="ruleForm.kaifadianhua" placeholder="开发电话" readonly></el-input>
				</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='kaifadianhua'){
							this.ruleForm.kaifadianhua = obj[o];
							this.ro.kaifadianhua = true;
							continue;
						}
