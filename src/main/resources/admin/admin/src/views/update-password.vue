		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'xiangmujingli') {
					}
					if (this.$storage.get("sessionTable") == 'ceshijingli') {
					}
					if (this.$storage.get("sessionTable") == 'ceshigongchengshi') {
					}
					if (this.$storage.get("sessionTable") == 'kaifarenyuan') {
					}
					if (this.$storage.get("sessionTable") == 'fenxishi') {
					}
					if (this.ruleForm.password != password) {
						this.$message.error("原密码错误");
						return;
